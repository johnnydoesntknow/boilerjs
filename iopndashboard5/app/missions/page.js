                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className={`text-sm font-semibold ${
                          theme === "light" ? "text-cyan-700" : "text-bright-aqua"
                        }`}>
                          Daily Missions
                        </p>
                        <p className={`text-2xl font-bold ${
                          theme === "light" ? "text-gray-900" : "text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]"
                        }`}>
                          {missions.filter(m => m.type === "daily" && m.status !== "completed").length}
                        </p>
                      </div>
                      <Clock className={`w-8 h-8 ${
                        theme === "light" ? "text-cyan-600" : "text-bright-aqua drop-shadow-[0_0_10px_rgba(0,255,255,0.5)]"
                      }`} />
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Target className={`w-8 h-8 ${
                        theme === "light" ? "text-purple-600" : "text-violet-indigo drop-shadow-[0_0_10px_rgba(139,0,255,0.5)]"
                      }`} />
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className={theme === "light"
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className={`text-sm font-semibold ${
                          theme === "light" ? "text-orange-700" : "text-amber-rust"
                        }`}>
                          Total REP Available
                        </p>
                        <p className={`text-2xl font-bold ${
                      ...
                      <Zap className={`w-8 h-8 ${
                        theme === "light" ? "text-orange-600" : "text-amber-rust drop-shadow-[0_0_10px_rgba(255,140,0,0.5)]"
                      }`} />
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className={theme === "light"
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className={`text-sm font-semibold ${
                          theme === "light" ? "text-red-700" : "text-crimson-red"
                        }`}>
                          Completed
                        </p>
                        <p className={`text-2xl font-bold ${
                      ...
                      <CheckCircle2 className={`w-8 h-8 ${
                        theme === "light" ? "text-red-600" : "text-crimson-red drop-shadow-[0_0_10px_rgba(220,20,60,0.5)]"
                      }`} />
                    </div>
                  </CardContent>
                </Card>
