            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
              <Card className={`${
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-gray-400">Daily Missions</p>
              ...
              <Card className={`${
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-gray-400">Weekly Missions</p>
                      <p className="text-2xl font-bold">
              ...
              <Card className={`${
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-gray-400">Total REP Available</p>
                      <p className="text-2xl font-bold">
                        {missions
                  ...
                  <TabsContent value={filter} className="mt-6 space-y-4">
                                ...
                                <div className="space-y-2 mb-4">
                                  {mission.requirements.map((req, index) => (
                                    <div key={index} className="flex items-center gap-2 text-sm">
                                      ...
                                      <span className={isCompleted ? "text-gray-500 line-through" : "text-gray-400"}>
                                        {req}
                                      </span>
                                    </div>
                                  ))}
                    ...
                    {filteredMissions.length === 0 && (
                      <div className="text-center py-12">
                        ...
                        <p className="text-gray-400">No missions found in this category</p>
                      </div>
                    )}
                  </TabsContent>
                </Tabs>
