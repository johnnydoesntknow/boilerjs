...
export default function NFTMintPage() {
  ...
  const [randomId, setRandomId] = useState(null) // Fix for hydration error

  // Generate random ID on client side only
  useEffect(() => {
    setRandomId(Math.floor(Math.random() * 9999) + 1)
  }, [])
