        ...
        <div className="flex-1 overflow-y-auto">
          <div className="min-h-full bg-black cyber-grid hex-pattern p-4 md:p-8">
            <div className="max-w-[1400px] mx-auto w-full">
              ...
              {/* User Stats - Using actual userREP */}
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 lg:mb-8">
                <Card className={`${
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-bright-aqua font-semibold">Your Rank</p>
                        <p className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">#{userRank}</p>
                      </div>
                      <Trophy className="w-8 h-8 text-bright-aqua drop-shadow-[0_0_10px_rgba(0,255,255,0.5)]" />
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className={`${
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-violet-indigo font-semibold">Total REP</p>
                        <p className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">
                          {userREP.toLocaleString()}
                        </p>
                      </div>
                      <Star className="w-8 h-8 text-violet-indigo drop-shadow-[0_0_10px_rgba(139,0,255,0.5)]" />
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className={`${
                  theme === "light" 
                    ? "bg-white border-gray-200" 
                    : "bg-gradient-to-br from-amber-rust/20 to-amber-rust/10 border-amber-rust/50 shadow-[0_0_20px_rgba(255,140,0,0.3)]"
                }`}>
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-amber-rust font-semibold">Weekly Points</p>
                        <p className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">
                          {currentUser?.weeklyPoints || 5}
                        </p>
                      </div>
                      <TrendingUp className="w-8 h-8 text-amber-rust drop-shadow-[0_0_10px_rgba(255,140,0,0.5)]" />
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className={`${
                  theme === "light" 
                    ? "bg-white border-gray-200" 
                    : "bg-gradient-to-br from-crimson-red/20 to-crimson-red/10 border-crimson-red/50 shadow-[0_0_20px_rgba(220,20,60,0.3)]"
                }`}>
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-crimson-red font-semibold">To Top 50</p>
                        <p className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">
                          {pointsToTop50 > 0 ? `${pointsToTop50} REP` : "You're in!"}
                        </p>
                      </div>
                      <Users className="w-8 h-8 text-crimson-red drop-shadow-[0_0_10px_rgba(220,20,60,0.5)]" />
                    </div>
                  </CardContent>
                </Card>
              </div>

              {/* Top 3 Showcase - Updated with dynamic data */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                {dynamicLeaderboard.slice(0, 3).map((player, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`absolute inset-0 bg-gradient-to-br ${getRankBgColor(player.rank)} opacity-50`} />
                    ...
                    {userRank > 50 && currentUser && (
                      <>
                        ...
                        >
                          ...
                          <div className="col-span-5 flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-indigo to-bright-aqua flex items-center justify-center">
                              <span className="text-white font-semibold text-xs">
                          ...
                          <div className="col-span-2 text-right">
                            <p className={`font-medium ${
                              currentUser.weeklyPoints > 0 ? "text-green-500" : "text-gray-500"
                            }`}>
