...
export default function LeaderboardPage() {
  ...
  // Get user's data from the leaderboard
  const currentUser = mockLeaderboard.find(player => player.isUser)
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">5</p>
                    </div>
