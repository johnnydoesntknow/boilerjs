            ...
            <div className="text-center space-y-6 max-w-md w-full">
              ...
              <div className="space-y-4">
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-violet-indigo to-bright-aqua hover:from-violet-indigo/90 hover:to-bright-aqua/90 cyber-button pulse-glow text-white font-bold py-3 sm:py-4 text-base sm:text-lg transition-all duration-300"
                  size="lg"
                >
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        {/* HEADER */}
        <header
          className={`flex h-14 lg:h-16 shrink-0 items-center gap-2 border-b px-3 sm:px-4 transition-all duration-300 ${
            theme === "light"
        ...
        >
          ...
          <Separator
            ...
            className={`mx-2 sm:mx-4 lg:mx-8 h-4 ${theme === "light" ? "bg-gray-300" : "bg-bright-aqua/30"}`}
          />

          <div className="flex items-center justify-between w-full">
            {/* Left - Simple welcome */}
            <div className="flex items-center space-x-2 lg:space-x-4 min-w-0">
              <Avatar className={`h-8 w-8 border flex-shrink-0 ${theme === "light" ? "border-gray-300" : "border-bright-aqua/30"}`}>
              ...
              <div className="min-w-0">
                <p className={`text-xs lg:text-sm font-medium truncate ${theme === "light" ? "text-gray-900" : "text-white"}`}>
                  Welcome back
                </p>
                <p className={`text-xs truncate ${theme === "light" ? "text-gray-700" : "text-gray-500"}`}>
        ...
        {/* Main Content */}
        <main
          className={`flex-1 space-y-4 lg:space-y-6 p-3 sm:p-4 lg:p-6 min-h-screen transition-all duration-300 overflow-x-hidden ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-6 lg:mb-8">
            ...
            >
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className={`text-xs sm:text-sm font-medium ${theme === "light" ? "text-gray-600" : "text-gray-400"}`}>
                  Total REP Points
                </CardTitle>
                <Star className={`h-4 w-4 ${theme === "light" ? "text-blue-500" : "text-bright-aqua"}`} />
              </CardHeader>
              <CardContent>
                <div className={`text-xl sm:text-2xl font-bold ${theme === "light" ? "text-blue-600" : "text-bright-aqua"}`}>
            ...
            >
              ...
              <CardContent>
                <div className={`text-xl sm:text-2xl font-bold ${theme === "light" ? "text-orange-600" : "text-amber-rust"}`}>
                  12
                </div>
            ...
            >
              ...
              <CardContent>
                <div className={`text-xl sm:text-2xl font-bold ${theme === "light" ? "text-red-600" : "text-crimson-red"}`}>8</div>
