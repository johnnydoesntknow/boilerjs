...
export default function Dashboard() {
  ...
  <SidebarProvider>
    ...
    <SidebarInset>
      ...
      {/* HEADER */}
      <header className={`sticky top-0 z-50 flex h-14 lg:h-16 items-center gap-2 border-b px-3 sm:px-4 transition-all duration-300 ${
        theme === "light"
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center space-x-2 lg:space-x-4">
            ...
            <div>
              <p className={`text-xs lg:text-sm font-medium ${theme === "light" ? "text-gray-900" : "text-white"}`}>
                Welcome back
              </p>
