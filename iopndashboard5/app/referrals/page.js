          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
              <Card className={`${
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Users className="w-8 h-8 text-bright-aqua" />
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-green-500">{activeReferrals}</p>
                    </div>
              ...
              <Card className={`${
                theme === "light" 
                  ? "bg-white border-gray-200" 
                  : "bg-black/60 border-yellow-500/20"
              }`}>
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
              ...
              <Card className={`${
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-gray-400">REP Earned</p>
                      <p className="text-2xl font-bold text-violet-indigo">{totalEarned}</p>
                    </div>
                    <TrendingUp className="w-8 h-8 text-violet-indigo" />
                  </div>
                </CardContent>
              </Card>
            </div>
