...
import { Save, X, Star, Sparkles, Plus } from "lucide-react"
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        <div className={`min-h-screen transition-all duration-300 ${
          theme === "light" ? "bg-gray-50" : "bg-black cyber-grid"
        }`}>
              ...
              <div className="space-y-4">
                ...
                <Card className={`${
                  ...
                  <CardContent>
                    <div 
                      ref={nftContainerRef}
                      className="relative rounded-lg overflow-hidden mb-6 bg-black"
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className={`text-sm ${
                          ...
                          {walletAddress ? formatAddress(walletAddress) : "fgdrnfnfgngrig"}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <Badge className="bg-bright-aqua text-white">Rare</Badge>
                        </div>
                      </div>
                      ...
                      <Button
                        ...
                        className={`w-full ${
                          hasChanges 
                            ? "cyber-button pulse-glow bg-gradient-to-r from-bright-aqua to-violet-indigo hover:from-bright-aqua/90 hover:to-violet-indigo/90" 
                                    ...
                                    <div
                                      ...
                                      className={`p-4 rounded-lg border ${
                                        theme === "light"
                                          ...
                                          : "bg-black/60 border-bright-aqua/30"
                                      }`}
                                    >
                                      <div className="text-center">
                                        ...
                                        <Badge 
                                          variant="secondary" 
                                          className={`mb-2 ${
                                            badge.rarity === "legendary" ? "bg-amber-rust text-white" :
                                            badge.rarity === "epic" ? "bg-violet-indigo text-white" :
                                            badge.rarity === "rare" ? "bg-bright-aqua text-white" :
                                        ...
                                        <Button
                                          ...
                                          className={`w-full ${
                                            theme === "light"
                                              ...
                                              : "border-bright-aqua/30 text-bright-aqua hover:bg-bright-aqua/10"
                                          }`}
                                        >
                                          Remove from NFT
                                        </Button>
