              ...
              <div className="flex justify-center mb-8">
                <Card className={`${
                  ...
                  <CardContent className="p-4 flex items-center gap-6">
                    <div className="text-center">
                      <p className="text-sm text-bright-aqua font-semibold mb-1">Your REP</p>
                      <p className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">
                        {userREP.toLocaleString()}
                      </p>
                    </div>
                    <div className="h-12 w-px bg-violet-indigo/30" />
                    <div className="text-center">
                      <p className="text-sm text-violet-indigo font-semibold mb-1">Badges Owned</p>
                      <p className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">
                        {userBadges.length}
                      </p>
                    </div>
                    <div className="h-12 w-px bg-violet-indigo/30" />
                    <div className="text-center">
                      <p className="text-sm text-amber-rust font-semibold mb-1">Active Listings</p>
                      <p className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">
                        {userListings.length}
                      </p>
                    </div>
                            ...
                            return (
                              ...
                              >
                                <CardContent className="p-6">
                                  {/* User Listing Badge */}
                                  {badge.isUserListing && (
                                    <Badge className="absolute top-2 right-2 bg-violet-indigo text-white">
                                      User Listing
                                    </Badge>
                                  )}
                    ...
                    <CardContent>
                      {userListings.length === 0 ? (
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-400 mb-2">No active listings</p>
                          <p className="text-sm text-gray-500">
                                ...
                                <div className="flex items-center gap-4">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <Badge variant="secondary" className={`mt-1 ${
                                      listing.badge.rarity === "legendary" ? "bg-yellow-500/20 text-yellow-500" :
                                      listing.badge.rarity === "epic" ? "bg-purple-500/20 text-purple-500" :
                                      listing.badge.rarity === "rare" ? "bg-blue-500/20 text-blue-500" :
                                      "bg-gray-500/20 text-gray-500"
                                    }`}>
                                  ...
                                  <div className="text-right">
                                    ...
                                    <p className="text-lg font-bold text-bright-aqua">{listing.price} REP</p>
                                  </div>
                                  ...
                                  <div className="flex gap-2">
                                    <Button
                                      ...
                                      className={theme === "light" ? "" : "border-bright-aqua/50 text-bright-aqua hover:bg-bright-aqua/10"}
                                    >
                                      Update Price
                                    </Button>
                                    <Button
                                      ...
                                      className={theme === "light" ? "" : "border-crimson-red/50 text-crimson-red hover:bg-crimson-red/10"}
                                    >
                                      Cancel Listing
                                    </Button>
                                  </div>
        ...
        <Dialog open={showSellDialog} onOpenChange={setShowSellDialog}>
          <DialogContent className={`${
            ...
            <DialogHeader>
              ...
              <DialogDescription className={theme === "light" ? "" : "text-gray-400"}>
              ...
              <div className="space-y-4">
                <div className={`flex items-center gap-4 p-4 rounded-lg ${
                  ...
                  <div>
                    ...
                    <Badge variant="secondary" className={`mt-1 ${
                      selectedBadgeToSell.rarity === "legendary" ? "bg-yellow-500/20 text-yellow-500" :
                      selectedBadgeToSell.rarity === "epic" ? "bg-purple-500/20 text-purple-500" :
                      selectedBadgeToSell.rarity === "rare" ? "bg-blue-500/20 text-blue-500" :
                      "bg-gray-500/20 text-gray-500"
                    }`}>
                ...
                <div className="space-y-2">
                  <Label htmlFor="sale-price" className={theme === "light" ? "" : "text-white"}>
                    Sale Price (REP)
                  </Label>
                  <Input
                    id="sale-price"
                    ...
                    className={theme === "light" ? "" : "bg-black/40 border-gray-700 text-white"}
                  />
            ...
            <DialogFooter>
              <Button
                ...
                className={theme === "light" ? "" : "border-gray-700 text-gray-300 hover:bg-gray-800"}
              >
                Cancel
              </Button>
              <Button
                ...
                className="cyber-button bg-gradient-to-r from-amber-rust to-crimson-red hover:from-amber-rust/90 hover:to-crimson-red/90 text-white"
              >
                List for Sale
              </Button>
            </DialogFooter>
