...
import { Zap, Shield, Star, Lock, ShoppingCart, Filter } from "lucide-react"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 text-lg">
                Unlock exclusive badges with your REP points
              </p>
            </div>
                ...
                <CardContent className="p-4 flex items-center gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-2xl font-bold text-amber-rust">
                      {mockBadges.filter(b => !userBadges.includes(b.id)).length}
                    </p>
                  </div>
                </CardContent>
              </Card>
