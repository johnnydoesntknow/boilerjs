        ...
        <div className="flex-1 overflow-y-auto">
          <div className={`min-h-full p-4 md:p-8 ${
            ...
            <div className="max-w-6xl mx-auto">
              ...
              {/* Main Tabs - Fixed for mobile */}
              <Tabs value={activeMainTab} onValueChange={setActiveMainTab} className="w-full">
                <TabsList className="grid w-full grid-cols-4 mb-6">
                  <TabsTrigger value="buy" className="flex items-center gap-1 px-2">
                    <ShoppingCart className="w-4 h-4 hidden sm:inline" />
                    <span className="text-xs sm:text-sm">Buy</span>
                  </TabsTrigger>
                  <TabsTrigger value="sell" className="flex items-center gap-1 px-2">
                    <DollarSign className="w-4 h-4 hidden sm:inline" />
                    <span className="text-xs sm:text-sm">Sell</span>
                  </TabsTrigger>
                  <TabsTrigger value="listings" className="flex items-center gap-1 px-2">
                    <Settings className="w-4 h-4 hidden sm:inline" />
                    <span className="text-xs sm:text-sm">Listings</span>
                  </TabsTrigger>
                  <TabsTrigger value="merchandise" className="flex items-center gap-1 px-2">
                    <Gift className="w-4 h-4 hidden sm:inline" />
                    <span className="text-xs sm:text-sm">Merch</span>
                  </TabsTrigger>
                </TabsList>
