export const mockUser = {
  ...
  discordId: "alex_chen#1234",
  walletAddress: "0x1234...5678",
  repPoints: 10000, // Changed from 180 to 10000
  badges: [
...
export const mockLeaderboard = [
  { id: "1", name: "Jimi", totalPoints: 10000, weeklyPoints: 5, badges: 12, rank: 1, isUser: true },
  { id: "2", name: "CryptoNinja", totalPoints: 5420, weeklyPoints: 850, badges: 24, rank: 2 }, // Changed ID from "1" to "2"
...
export const mockBadges = [
  {
    ...
    rarity: "legendary",
    price: 0,
    image: "/images/badges/originator.png",
  ...
  },
  {
    ...
    rarity: "epic",
    price: 150,
    image: "/images/badges/culture-catalyst.png",
    category: "social",
    owned: true,
    equipped: true,
    repThreshold: 1000,
  },
  {
    ...
    rarity: "rare",
    price: 75,
    image: "/images/badges/signal-runner.png",
    category: "social",
    owned: true,
    equipped: false,
    repThreshold: 500,
  },
  {
    ...
    rarity: "epic",
    price: 200,
    image: "/images/badges/network-architect.png",
    category: "technical",
    owned: false,
    equipped: false,
    repThreshold: 1500,
  },
  {
    ...
    rarity: "legendary",
    price: 250,
    image: "/images/badges/server-og.png",
    category: "technical",
    owned: false,
    equipped: false,
    repThreshold: 2500,
